...
// Purpose: Admin dashboard overview - main stats page
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <a href="/admin/dashboard/vendors" className="mt-4 inline-block text-sm font-medium text-blue-600 hover:text-blue-700">
            View Vendors →
          </a>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <a href="/admin/dashboard/rfqs" className="mt-4 inline-block text-sm font-medium text-orange-600 hover:text-orange-700">
            Manage RFQs →
          </a>
        </div>
