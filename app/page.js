    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative overflow-hidden bg-slate-950 text-white">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(202,134,55,0.18),transparent_55%)]" />
          ...
          <div className="grid lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-6">
              <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm text-gray-200">
                ...
                Verified vendors • Faster quotes • Clear comparisons
              </div>

              <h1 className="mt-6 text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.05]">
                Get construction quotes from <span className="text-amber-300">verified</span> vendors — and compare them easily.
              </h1>

              <p className="mt-5 text-lg sm:text-xl text-gray-200 max-w-xl leading-relaxed">
                Post one RFQ, reach multiple vendors, and choose confidently with transparent pricing and profiles.
              </p>

              <div className="mt-6 grid sm:grid-cols-2 gap-3 max-w-xl">
                <div className="flex items-center gap-2 text-gray-200">
                  <CheckCircle className="w-5 h-5 text-amber-300" />
                  Auto-matching to the right category
                </div>
                <div className="flex items-center gap-2 text-gray-200">
                  <MessageSquare className="w-5 h-5 text-amber-300" />
                  Message vendors before committing
                </div>
                <div className="flex items-center gap-2 text-gray-200">
                ...
                <div className="flex items-center gap-2 text-gray-200">
                  ...
                  Faster responses on active RFQs
                </div>
              </div>
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-3 sm:items-center">
                ...
                {vendorProfileLink && (
                  <Link href={vendorProfileLink} className="text-sm text-gray-200 hover:text-white underline underline-offset-4 sm:ml-2">
                    Go to My Vendor Profile
                  </Link>
                )}
              </div>
            ...
            <div className="lg:col-span-6">
              <div className="relative">
                <div className="absolute -inset-6 bg-[radial-gradient(circle,rgba(202,134,55,0.18),transparent_60%)] blur-2xl" />
                ...
                <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-2xl">
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <div className="inline-flex items-center gap-2 rounded-full bg-slate-950/60 border border-white/10 px-4 py-2 text-sm text-gray-100 backdrop-blur">
                      <ArrowRight className="w-4 h-4 text-amber-300" />
                      Compare quotes side-by-side before you hire
                    </div>
                  </div>
                </div>
              </div>
