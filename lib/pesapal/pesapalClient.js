...
// DEPRECATED: This client library is deprecated
// Use server-side API routes instead:
// - POST /api/payments/pesapal/initiate
// - POST /api/webhooks/pesapal
// 
// These routes handle all OAuth and crypto operations server-side
// to prevent 'undefined CONSUMER_SECRET' errors on client/Vercel
//
// Legacy exports kept for backward compatibility but should not be used
let pesapalClientInstance = null;

function getPesaPalClientInstance() {
  // Only instantiate on server-side (Node.js environment)
