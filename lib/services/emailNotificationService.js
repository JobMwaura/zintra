  ...
  <div style="max-width: 600px; margin: 0 auto; background: white;">
    ...
    <div style="padding: 40px 30px;">
      ...
      <div style="text-align: center; margin: 30px 0;">
        <a href="https://zintra-sandy.vercel.app/messages" 
...
Log in to view and reply: https://zintra-sandy.vercel.app/messages
...
<body style="font-family: Arial, sans-serif; margin: 0; padding: 0; background-color: #f5f5f5;">
  <div style="max-width: 600px; margin: 0 auto; background: white;">
    ...
    <div style="padding: 40px 30px;">
      ...
      <!-- CTA Button -->
      <div style="text-align: center; margin: 30px 0;">
        <a href="https://zintra-sandy.vercel.app/vendor/profile" 
           style="display: inline-block; background: #007bff; color: white; padding: 14px 30px; text-decoration: none; border-radius: 6px; font-weight: bold; font-size: 16px;">
          View Message
        </a>
      </div>
...
Log in to view and reply: https://zintra-sandy.vercel.app/vendor/profile
