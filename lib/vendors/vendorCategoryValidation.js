 ...
 * 
 * Validates that vendor categories are from the canonical 20 categories.
 * Source of truth: CANONICAL_CATEGORIES from lib/categories/canonicalCategories.js
 */
 ...
 * @returns {string[]} Array of valid category slugs from CANONICAL_CATEGORIES
 */
 ...
 * @returns {boolean} True if slug is in CANONICAL_CATEGORIES
 */
