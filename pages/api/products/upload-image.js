// /pages/api/products/upload-image.js
// Presigned URL generation for product image uploads to AWS S3
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Generate presigned URL for product images with correct S3 path
    console.log('🔄 Generating presigned URL for product image...');
    ...
    const uploadResult = await generatePresignedUploadUrl(
      ...
      `vendor-profiles/products/${user.id}/`,
